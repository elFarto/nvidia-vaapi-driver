...
YUV444 video support is coming soon (see #134).
...
Is your distros package missing? Let us know in an issue/PR.
...
**IMPORTANT**: The [direct backend](#direct-backend) is currently required on NVIDIA driver series 525 due to a regression (see #126).
...
In addition, this backend has only been tested on Pascal (10XX) and Turing Mobile (20XX). Let us know if you successful using this on other generations. If you encounter issues using this backend raise an issue and including logs from `NVD_LOG=1`.
